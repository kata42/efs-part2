...
from .models import Customer,Stock,Investment,User,Mutualfund
...
class MutualfundForm(forms.ModelForm):
   class Meta:
       model = Mutualfund
       fields = ('customer', 'symbol', 'description', 'shares', 'acquired_value', 'acquired_date', 'recent_value', 'recent_date',)