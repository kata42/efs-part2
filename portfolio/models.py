...
class Stock(models.Model):
    ...
    def current_stock_price(self):
        ...
        api_key = '&apikey= 99610BL2K247JW9W'
    ...
    def currency_stock_price(self):
        c = CurrencyConverter()
        currency = c.convert(float(self.purchase_price), 'USD', 'INR')
...
class Mutualfund(models.Model):
    ...
    def total_initial_mutual_funds(self):
        return self.acquired_value * self.shares

    def total_current_mutual_funds(self):
        return self.recent_value * self.shares

    def results_by_mutualfund(self):
        return self.total_initial_mutual_funds() - self.total_current_mutual_funds()